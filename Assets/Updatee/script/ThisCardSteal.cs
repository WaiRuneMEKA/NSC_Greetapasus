...
public class ThisCardSteal : MonoBehaviour
{
    public AudioSource sourceSteal;
    public AudioClip clipSteal;
    ...
    void Start()
    {
        ...
        numberOfCardsInDeck = StealDeck.deckSize;
    ...
    void Update()
    {
        ...
        if (this.tag == "Hand")
        {
            thisCard[0] = StealDeck.staticDeck[numberOfCardsInDeck - 1];
            numberOfCardsInDeck -= 1;
            StealDeck.deckSize -= 1;
            cardBack = false;
            this.tag = "Untagged";
        }
    ...
    public void Summon()
    {
        if (TurnSystem.currentMana >= cost)
        {
            ...
            if (drawXcards > 0)
            {
                ...
                Anime.SetTrigger("trs1");
                sourceSteal.PlayOneShot(clipSteal);
                Destroy();
            }
            if (healXpower > 0)
            {
