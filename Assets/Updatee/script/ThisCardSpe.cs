...
public class ThisCardSpe : MonoBehaviour
{
    private Animator Anime;
    public GameObject Effect;

    public AudioSource sourceAttack2;
    ...
    void Start()
    {
        ...
        numberOfCardsInDeck = FartDeck.deckSize;
    ...
    void Update()
    {
        ...
        if (this.tag == "Hand")
        {
            thisCard[0] = FartDeck.staticDeck[numberOfCardsInDeck - 1];
            ...
            if(addXmaxMana == 0 && drawXcards == 0 && healXpower == 0 && shieldXpower ==0 )
            {
                ...
                if (power == 2)
                {
                    if(EnemyShield.shield == 0)
                    {
                        ...
                        Debug.Log("kuy");
                        Anime.SetTrigger("tra2");
                        sourceAttack2.PlayOneShot(clipAttack2);
                        this.Destroy();
                    }
                    if (EnemyShield.shield > 0)
                    {
